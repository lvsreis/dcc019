...
(module reader racket
  ...
  (define (value-of exp Δ)
    (match exp
      ...
      [(ast:var v) (let ([v (deref (apply-env Δ v))]) ; call by name
                     (match v
                       [(thunk env e) (value-of e env)]
                       [_ v]))]
      ...
      [(ast:call e1 e2) ; call by name
       (match e2
         [(ast:var z) (apply-proc-ref (value-of e1 Δ) (apply-env Δ z))]
         [_ (apply-proc (value-of e1 Δ) (thunk Δ e2))])]
