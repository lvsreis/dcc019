...
(require parser-tools/yacc
         dcc019/exercise/let/lexer
         dcc019/exercise/let/ast)
  ...
  (parser
   ...
   (grammar
    ...
    (exp [(INT) (int-ast $1)]
         ...
         [(ADD LPAREN exp COMMA exp RPAREN ) (add-ast $3 $5)] ; +(exp, exp)
         [(MULT LPAREN exp COMMA exp RPAREN ) (mult-ast $3 $5)] ; *(exp, exp)
         [(DIV LPAREN exp COMMA exp RPAREN ) (div-ast $3 $5)] ; /(exp, exp)
    ))))
