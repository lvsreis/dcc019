  ...
  (parser
   ...
   (grammar
    ...
    (exp [(INT) (ast:int $1)]
         ...
         [(NEWREF LPAREN exp RPAREN) (ast:newref $3)]
         [(FREEREF LPAREN exp RPAREN) (ast:freeref $3)]
         [(DEREF LPAREN exp RPAREN) (ast:deref $3)]
         [(SETREF LPAREN exp COMMA exp RPAREN) (ast:setref $3 $5)])
    (exps [() '()]
